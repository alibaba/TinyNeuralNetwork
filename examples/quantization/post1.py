...
def main_worker(args):
    with model_tracer():
        ...
        model_path = '/home/ubuntu/lyn/vit_new.pth'
        ...
        quantizer = PostQuantizer(
            ...
            dummy_input, 
            work_dir='out',  
            config={ 'asymmetric': True, 'set_quantizable_op_stats': True, 'per_tensor': False}
            )
    ...
    with torch.no_grad():
        ...
        # The code section below is used to convert the model to the TFLite formats
        ...
        converter = TFLiteConverter(
            ...
            tflite_path='out/vit_final.tflite')
        converter.convert()
